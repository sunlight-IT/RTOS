...
static const osal_queue_ops_t osal_freertos_queue_ops = {
    ...
    .send_from_isr = osal_port_freertos_queue_send_from_isr,
    .receive_from_isr = osal_port_freertos_queue_receive_from_isr,
...
static const osal_mutex_ops_t osal_freertos_mutex_ops = {
    ...
    .try_acquire = osal_port_freertos_mutex_try_acquire,
...
static const osal_semaphore_ops_t osal_freertos_semaphore_ops = {
    ...
    .release_from_isr = osal_port_freertos_semaphore_release_from_isr,
    .try_acquire = osal_port_freertos_semaphore_try_acquire,
...
static const osal_event_ops_t osal_freertos_event_ops = {
    ...
    .set_from_isr = osal_port_freertos_event_set_from_isr,
