...
typedef struct {
    ...
    osal_status_t (*send_from_isr)(osal_queue_t handle, const void* data,
                                   int* higher_pri_task_woken);
    osal_status_t (*receive_from_isr)(osal_queue_t handle, void* data, int* higher_pri_task_woken);
...
typedef struct {
    ...
    osal_status_t (*try_acquire)(osal_mutex_t handle);
...
typedef struct {
    ...
    osal_status_t (*release_from_isr)(osal_semaphore_t handle, int* higher_pri_task_woken);
    osal_status_t (*try_acquire)(osal_semaphore_t handle);
...
typedef struct {
    ...
    osal_status_t (*set_from_isr)(osal_event_t handle, osal_event_flags_t flags,
                                  int* higher_pri_task_woken);
