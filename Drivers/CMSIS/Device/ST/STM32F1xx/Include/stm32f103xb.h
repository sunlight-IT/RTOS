...
#define __NVIC_PRIO_BITS 3U       /*!< STM32 uses 4 Bits for the Priority Levels    */
...
typedef struct {
    __IO uint32_t SR;  /*!< ADC status register,    used for ADC multimode (bits common to several
                          ADC instances). Address offset: ADC1 base address         */
    __IO uint32_t CR1; /*!< ADC control register 1, used for ADC multimode (bits common to several
                          ADC instances). Address offset: ADC1 base address + 0x04  */
    __IO uint32_t CR2; /*!< ADC control register 2, used for ADC multimode (bits common to several
                          ADC instances). Address offset: ADC1 base address + 0x08  */
    uint32_t RESERVED[16];
    __IO uint32_t DR; /*!< ADC data register,      used for ADC multimode (bits common to several
                         ADC instances). Address offset: ADC1 base address + 0x4C  */
} ADC_Common_TypeDef;
...
#define USB_PMAADDR                                                              \
    (APB1PERIPH_BASE + 0x00006000UL) /*!< USB_IP Packet Memory Area base address \
                                      */
...
#define AFIO_MAPR_USART3_REMAP_PARTIALREMAP                                                \
    AFIO_MAPR_USART3_REMAP_PARTIALREMAP_Msk /*!< Partial remap (TX/PC10, RX/PC11, CK/PC12, \
                                               CTS/PB13, RTS/PB14) */
...
#define AFIO_MAPR_USART3_REMAP_FULLREMAP                                                     \
    AFIO_MAPR_USART3_REMAP_FULLREMAP_Msk /*!< Full remap (TX/PD8, RX/PD9, CK/PD10, CTS/PD11, \
                                            RTS/PD12) */
...
#define AFIO_MAPR_TIM1_REMAP_NOREMAP                                                      \
    0x00000000U /*!< No remap (ETR/PA12, CH1/PA8, CH2/PA9, CH3/PA10, CH4/PA11, BKIN/PB12, \
...
#define AFIO_MAPR_TIM1_REMAP_PARTIALREMAP                                                      \
    AFIO_MAPR_TIM1_REMAP_PARTIALREMAP_Msk /*!< Partial remap (ETR/PA12, CH1/PA8, CH2/PA9,      \
...
#define AFIO_MAPR_TIM1_REMAP_FULLREMAP                                                        \
    AFIO_MAPR_TIM1_REMAP_FULLREMAP_Msk /*!< Full remap (ETR/PE7, CH1/PE9, CH2/PE11, CH3/PE13, \
...
#define AFIO_MAPR_TIM2_REMAP_PARTIALREMAP1                                                     \
    AFIO_MAPR_TIM2_REMAP_PARTIALREMAP1_Msk /*!< Partial remap (CH1/ETR/PA15, CH2/PB3, CH3/PA2, \
                                              CH4/PA3) */
...
#define AFIO_MAPR_TIM2_REMAP_PARTIALREMAP2                                                     \
    AFIO_MAPR_TIM2_REMAP_PARTIALREMAP2_Msk /*!< Partial remap (CH1/ETR/PA0, CH2/PA1, CH3/PB10, \
                                              CH4/PB11) */
...
#define AFIO_MAPR_CAN_REMAP \
    AFIO_MAPR_CAN_REMAP_Msk /*!< CAN_REMAP[1:0] bits (CAN Alternate function remapping) */
...
#define AFIO_MAPR_SWJ_CFG \
    AFIO_MAPR_SWJ_CFG_Msk /*!< SWJ_CFG[2:0] bits (Serial Wire JTAG configuration) */
 ...
 */
#define ADC_MULTIMODE_SUPPORT /*!< ADC feature available only on specific devices: multimode \
                                 available on devices with several ADC instances */
...
#define ADC_CR1_EOSIE \
    ADC_CR1_EOSIE_Msk /*!< ADC group regular end of sequence conversions interrupt */
...
#define ADC_CR1_JEOSIE \
    ADC_CR1_JEOSIE_Msk /*!< ADC group injected end of sequence conversions interrupt */
...
#define ADC_CR1_AWDSGL \
    ADC_CR1_AWDSGL_Msk /*!< ADC analog watchdog 1 monitoring a single channel or all channels */
...
#define ADC_CR1_DISCNUM \
    ADC_CR1_DISCNUM_Msk /*!< ADC group regular sequencer discontinuous number of ranks */
...
#define ADC_CR1_JAWDEN \
    ADC_CR1_JAWDEN_Msk /*!< ADC analog watchdog 1 enable on scope ADC group injected */
#define ADC_CR1_AWDEN_Pos (23U)
#define ADC_CR1_AWDEN_Msk (0x1UL << ADC_CR1_AWDEN_Pos) /*!< 0x00800000 */
#define ADC_CR1_AWDEN \
    ADC_CR1_AWDEN_Msk /*!< ADC analog watchdog 1 enable on scope ADC group regular */
...
#define ADC_CR2_TSVREFE \
    ADC_CR2_TSVREFE_Msk /*!< ADC internal path to VrefInt and temperature sensor enable */
...
#define ADC_DR_ADC2DATA \
    ADC_DR_ADC2DATA_Msk /*!< ADC group regular conversion data for ADC slave, in multimode */
...
#define USB_EP0R_STAT_TX \
    USB_EP0R_STAT_TX_Msk /*!< STAT_TX[1:0] bits (Status bits, for transmission transfers) */
...
#define USB_EP0R_STAT_RX \
    USB_EP0R_STAT_RX_Msk /*!< STAT_RX[1:0] bits (Status bits, for reception transfers) */
...
#define USB_EP1R_STAT_TX \
    USB_EP1R_STAT_TX_Msk /*!< STAT_TX[1:0] bits (Status bits, for transmission transfers) */
...
#define USB_EP1R_STAT_RX \
    USB_EP1R_STAT_RX_Msk /*!< STAT_RX[1:0] bits (Status bits, for reception transfers) */
...
#define USB_EP2R_STAT_TX \
    USB_EP2R_STAT_TX_Msk /*!< STAT_TX[1:0] bits (Status bits, for transmission transfers) */
...
#define USB_EP2R_STAT_RX \
    USB_EP2R_STAT_RX_Msk /*!< STAT_RX[1:0] bits (Status bits, for reception transfers) */
...
#define USB_EP3R_STAT_TX \
    USB_EP3R_STAT_TX_Msk /*!< STAT_TX[1:0] bits (Status bits, for transmission transfers) */
...
#define USB_EP3R_STAT_RX \
    USB_EP3R_STAT_RX_Msk /*!< STAT_RX[1:0] bits (Status bits, for reception transfers) */
...
#define USB_EP4R_STAT_TX \
    USB_EP4R_STAT_TX_Msk /*!< STAT_TX[1:0] bits (Status bits, for transmission transfers) */
...
#define USB_EP4R_STAT_RX \
    USB_EP4R_STAT_RX_Msk /*!< STAT_RX[1:0] bits (Status bits, for reception transfers) */
...
#define USB_EP5R_STAT_TX \
    USB_EP5R_STAT_TX_Msk /*!< STAT_TX[1:0] bits (Status bits, for transmission transfers) */
...
#define USB_EP5R_STAT_RX \
    USB_EP5R_STAT_RX_Msk /*!< STAT_RX[1:0] bits (Status bits, for reception transfers) */
...
#define USB_EP6R_STAT_TX \
    USB_EP6R_STAT_TX_Msk /*!< STAT_TX[1:0] bits (Status bits, for transmission transfers) */
...
#define USB_EP6R_STAT_RX \
    USB_EP6R_STAT_RX_Msk /*!< STAT_RX[1:0] bits (Status bits, for reception transfers) */
...
#define USB_EP7R_STAT_TX \
    USB_EP7R_STAT_TX_Msk /*!< STAT_TX[1:0] bits (Status bits, for transmission transfers) */
...
#define USB_EP7R_STAT_RX \
    USB_EP7R_STAT_RX_Msk /*!< STAT_RX[1:0] bits (Status bits, for reception transfers) */
...
#define DBGMCU_CR_TRACE_MODE \
    DBGMCU_CR_TRACE_MODE_Msk /*!< TRACE_MODE[1:0] bits (Trace Pin Assignment Control) */
...
#define DBGMCU_CR_DBG_WWDG_STOP \
    DBGMCU_CR_DBG_WWDG_STOP_Msk /*!< Debug Window Watchdog stopped when Core is halted */
...
#define FLASH_WRP0_nWRP0 \
    FLASH_WRP0_nWRP0_Msk /*!< Flash memory write protection complemented option bytes */
...
#define FLASH_WRP1_nWRP1 \
    FLASH_WRP1_nWRP1_Msk /*!< Flash memory write protection complemented option bytes */
...
#define FLASH_WRP2_nWRP2 \
    FLASH_WRP2_nWRP2_Msk /*!< Flash memory write protection complemented option bytes */
...
#define FLASH_WRP3_nWRP3 \
    FLASH_WRP3_nWRP3_Msk /*!< Flash memory write protection complemented option bytes */
